const categoryContent = {
  ...
  lps: {
    title: "LPS",
    desc: "Laporan ekonomi yang menyajikan gambaran terkini dan insight perekonomian dari Lembaga LPS.",
  },
  indef: {
    title: "INDEF",
  ...
  data: {
    title: "Data",
    desc: "Kompilasi data dari Asosiasi/Kementerian/Lembaga/Dinas/Instansi untuk Penyusunan PDB Pengeluaran.",
  },
  pengeluaran: {
  ...
  suplemen: {
    title: "Suplemen",
    desc: "Informasi yang menyajikan data dan indikator pendukung yang memberikan gambaran terkini mengenai dinamika perekonomian Indonesia.",
  },
  vicon: {
    title: "Vicon",
